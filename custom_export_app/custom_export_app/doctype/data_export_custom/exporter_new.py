...
from custom_export_app.custom_export_app.doctype.data_export_custom.csvutils import build_csv_response, save_as_attachment_custom_export
from custom_export_app.custom_export_app.doctype.data_export_custom.xlsxutils import build_xlsx_response, save_as_attachment_xlsx_custom_export
...
class Exporter:
	...
	def build_response(self):
		if self.file_type == "CSV":
			print(_(self.doctype))
			print(_(self.docname))
			save_as_attachment_custom_export(self.get_csv_array_for_export(), _(self.doctype), _(self.docname))
		elif self.file_type == "Excel":
			save_as_attachment_xlsx_custom_export(self.get_csv_array_for_export(), _(self.doctype), _(self.docname))
