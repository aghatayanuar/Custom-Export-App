...
def save_as_attachment_xlsx_custom_export(data, doctype, docname):
    ...
    try:
        ...
        filename = f"{doctype}-{timestamp}.xlsx"
        ...
        xlsx_data = make_xlsx(data, filename).getvalue()
        ...
        frappe.db.commit()
        frappe.log_error(message=str(e), title="Export XLSX Failed")
        return None
