...
from frappe.utils import cint, comma_or, cstr, flt, now_datetime
...
def save_as_attachment_custom_export(data, doctype, docname):
	try:
		content = cstr(to_csv(data))
		timestamp = now_datetime().strftime("%Y%m%d%H%M%S")
		filename = f"{doctype}-{timestamp}.csv"
